            ...
            <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                {
                    playersData.map(playerData =>(
                        <div key={playerData.playerId} className="card bg-base-200 w-full shadow-xl border-2 p-5 ">
                            <figure>
                                <img
                            ...
                            <div className="flex gap-2 items-center my-3">
                                ...
                                <h1 className="text-lg md:text-xl font-semibold">{playerData.name}</h1>
                            </div>
                            ...
                            <div >
                                ...
                                <div className="flex justify-between items-center my-3">
                                    <h4 className="text-[15px] md:text-base font-medium">{playerData.battingType}</h4>
                                    <h4 className="text-gray-500 text-[15px] md:text-base font-normal">{playerData.bowlingType}</h4>
                                </div>
                            </div>
                            <div className="flex flex-col md:flex-row justify-between md:items-center gap-3 my-2">
                                <p className="text-base font-medium ">Price:  {playerData.biddingPrice}</p>
